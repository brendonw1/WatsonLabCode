function BWPreprocessing_EEGAccelerometer(basepath,noPrompts)
% Inputs optional
% 
...
%Get accelerometer channels from user
AccelChans = input('Which channels in your .lfp for Accelerometer data? ');
...
SleepScoreMaster(basepath,'noPrompts',noPrompts,'NotchUnder3Hz',true,'MotionSource','Accel','AccelerChans',AccelChans);
