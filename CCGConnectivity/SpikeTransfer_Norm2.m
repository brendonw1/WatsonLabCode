function [strengthbyratio, strengthbyratechg, ccg, measured, expected] = SpikeTransfer_Norm2(times1,times2,binSize,duration,sigbinms,ConvWidth,sameshank,SampleRate)
...
if ~exist('SampleRate','var')
    SampleRate = 1;%%Based on usual TSD object sample rate<< NEED TO GENERALIZE THIS, HAVEN'T FIGURED OUT HOW YET
end
