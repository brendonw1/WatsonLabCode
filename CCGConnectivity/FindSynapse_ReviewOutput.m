...
% plot E or I star at the proper bin
        if ~isempty(funcsynapses.ConnectionsE) & ismember([pre post],funcsynapses.ConnectionsE,'rows')
            thiscolor = 'g';
        elseif ~isempty(funcsynapses.ConnectionsI) & ismember([pre post],funcsynapses.ConnectionsI,'rows')
            thiscolor = 'r';
        end
