function SpikeTransferPerWakePortion = SpikeTransferPerWakePortion(basepath,basename,numdivisions)
...
SpikeTransferPerWakePortion = v2struct(EPairs,IPairs,ConnectionStarts,ConnectionEnds,Flips,...
    bintimes,normtimes,...
...
save(fullfile(basepath,[basename '_SpikeTransferPerWakePortion.mat']),'SpikeTransferPerWakePortion')
