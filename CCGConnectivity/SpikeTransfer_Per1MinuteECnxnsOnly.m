...
SpikeTransferPer1MinuteE = v2struct(window,windowstarts,windowends,...
...
save(fullfile(basepath,[basename '_SpikeTransferPer1MinuteE.mat']),'SpikeTransferPer1MinuteE');
