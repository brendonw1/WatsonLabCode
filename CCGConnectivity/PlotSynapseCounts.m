function h = PlotSynapseCounts(SynCounts)
...
h(1) = figure('name','TreeCountsSynCorr_Absolute','position',[100 100 750 600]);
...
h(2) = figure('name','TreeCountsSynCorr_Percents','position',[100 100 750 600]);
