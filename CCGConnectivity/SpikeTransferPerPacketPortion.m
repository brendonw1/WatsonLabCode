function SpikeTransferPerPacketPortion = SpikeTransferPerPacketPortion(basepath,basename,numdivisions)
...
SpikeTransferPerPacketPortion = v2struct(EPairs,IPairs,ConnectionStarts,ConnectionEnds,Flips,...
    bintimes,normtimes,...
...
save(fullfile(basepath,[basename '_SpikeTransferPerPacketPortion.mat']),'SpikeTransferPerPacketPortion')
