...
secondsperchunk = 5; %based on FST protocol
replayspeedup = 2;%fold faster than normal speed to replay
...
TotalMinToScore = 5;
TotalChunksToScore = TotalMinToScore*180/secondsperchunk; %180 for pretest
