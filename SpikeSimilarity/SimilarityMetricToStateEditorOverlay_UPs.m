function SimilarityMetricToStateEditorOverlay_UPs(m,evttimes,basename,metricname)
...
save(fullfile('UPstates',[basename '_StateEditorOverlay_' metricname]),'metricpertime')