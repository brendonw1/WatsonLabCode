function h = PlotEventSimilarities(m,rates,durs,amps,freqs,SleepStartIdxs,SleepStopIdxs)
...
subplot(6,1,1)
plot(smooth(perspindlemetric,smoothWindow))
yl = get(gca,'ylim');
