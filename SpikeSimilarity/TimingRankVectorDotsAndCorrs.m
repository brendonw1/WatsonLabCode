function [dotm,corrm,distm,zdotm,zcorrm,zdistm,sov] = TimingRankVectorDotsAndCorrs(times,normbool)
...
%%  Ranking cells by when they fired... 
...
% Ranking functions subsitute for above
