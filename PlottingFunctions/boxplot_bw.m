function h=boxplot_bw(varargin)
%BOXPLOT_BW - modification of matlab function boxplot.m.
...
%                     Default is 6.
%%%%%%%%% INSERTED BY BW
%     'percentiles'   Two element vector, sets which percentiles the top 
%                     and bottom of the boxes represent.  Range between 0 
%                     and 1 to represent proportion of whole.  Default is 
%                     25%ile and 75%ile (which is equal to entering 
%                     [.25 .75].
%%%%%%%%%
...
%%%%%%%%% INSERTED BY BW
%     'showall'       'on' or 'off' character string specifying whether all
%                     data points (not just outliers) are explicitly plotted.  Default is
%                     'off'
%%%%%%%%%
