function [board_dig_in_channels,sample_rate] = ...
    read_Intan_RHD2000_file_MOD_LB
...
tic;
filename = [path filesep file]; % filesep included by LSBUenoJr
...
% Move variables to base workspace. Commented by LSBuenoJr:
% TimestampsFromDigitalin.m will save the timestamp structure without
% moving unused variables from this Intan function to the workspace.
% The internal Intan function move_to_base_workspace was also
% commented at the end of this function
