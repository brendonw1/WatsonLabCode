function [meanspectrogram,varargout] = IntervalSetTriggeredSpectrogram...
...
%whiten for spectrogram... get rid of non-uniform power distribution
wlfp =  WhitenSignalIn(lfp,sampfreq*2000,1);
%spectrogram per second
spectrumduration = 1:%seconds duration per time band of the spectrogram
[fspec, fo, to] = mtchglongIn(wlfp, 3072, sampfreq, spectrumduration*sampfreq, 0, [], [], [], [0 200]);
