function [names,dirs] = SleepDataset_GetDatasetsDirs_SleepCells
...
if strcmp(cname(1:9),'MAC157688')%if I'm on my laptop
    bmdd = '/Users/brendon/Dropbox/Data/SleepDatasetAnalysis/BasicMetaData_SleepCells';
    d = getdir(bmdd);
    ld = length(d);
    for a = 1:ld;
        n = d(a).name;
    ...
    bmdd = '/mnt/brendon4/Dropbox/Data/SleepDatasetAnalysis/BasicMetaData_SleepCells/';
    d = getdir(bmdd);
    ld = length(d);
    for a = 1:ld;
        n = d(a).name;
