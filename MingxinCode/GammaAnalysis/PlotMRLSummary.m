function PlotMRLSummary(freqlist,PhstPS,jitmeanMRL,zthreshold,CellIDs,pvalues,yscaler)
...
%     plot(ax(3),xx(pvalues.E.H<0.01),ones(length(find(pvalues.E.H<0.01)),1)*(Ey*yl(3,2)-(Ey-1)*yl(3,1)),'*g','MarkerSize',2.5);
% end
% if find(pvalues.I.H<0.01,1)
%     plot(ax(3),xx(pvalues.I.H<0.01),ones(length(find(pvalues.I.H<0.01)),1)*(Iy*yl(3,2)-(Iy-1)*yl(3,1)),'*r','MarkerSize',2.5);
% end
% 
...
%     plot(ax(7),xx(pvalues.E.WAKEH<0.01),ones(length(find(pvalues.E.WAKEH<0.01)),1)*(Ey*yl(7,2)-(Ey-1)*yl(7,1)),'*g','MarkerSize',2.5);
% end
% if find(pvalues.I.WAKEH<0.01,1)
%     plot(ax(7),xx(pvalues.I.WAKEH<0.01),ones(length(find(pvalues.I.WAKEH<0.01)),1)*(Iy*yl(7,2)-(Iy-1)*yl(7,1)),'*r','MarkerSize',2.5);
% end
% 
...
%     plot(ax(11),xx(pvalues.E.NREMH<0.01),ones(length(find(pvalues.E.NREMH<0.01)),1)*(Ey*yl(11,2)-(Ey-1)*yl(11,1)),'*g','MarkerSize',2.5);
% end
% if find(pvalues.I.NREMH<0.01,1)
%     plot(ax(11),xx(pvalues.I.NREMH<0.01),ones(length(find(pvalues.I.NREMH<0.01)),1)*(Iy*yl(11,2)-(Iy-1)*yl(11,1)),'*r','MarkerSize',2.5);
% end
% 
...
%         plot(ax(15),xx(pvalues.E.REMH<0.01),ones(length(find(pvalues.E.REMH<0.01)),1)*(Ey*yl(15,2)-(Ey-1)*yl(15,1)),'*g','MarkerSize',2.5);
%     end
%     if find(pvalues.I.REMH<0.01,1)
%         plot(ax(15),xx(pvalues.I.REMH<0.01),ones(length(find(pvalues.I.REMH<0.01)),1)*(Iy*yl(15,2)-(Iy-1)*yl(15,1)),'*r','MarkerSize',2.5);
%     end
% 
...
%         plot(ax(4*NumRow-1),xx(pvalues.E.MAH<0.01),ones(length(find(pvalues.E.MAH<0.01)),1)*(Ey*yl(4*NumRow-1,2)-(Ey-1)*yl(4*NumRow-1,1)),'*g','MarkerSize',2.5);
%     end
%     if find(pvalues.I.MAH<0.01,1)
%         plot(ax(4*NumRow-1),xx(pvalues.I.MAH<0.01),ones(length(find(pvalues.I.MAH<0.01)),1)*(Iy*yl(4*NumRow-1,2)-(Iy-1)*yl(4*NumRow-1,1)),'*r','MarkerSize',2.5);
%     end
% 
...
if find(pvalues.EvI.all<0.01,1)
    plot(ax(1),xx(pvalues.EvI.all<0.01),ones(length(find(pvalues.EvI.all<0.01)),1)*(Ey*yl(1,2)-(Ey-1)*yl(1,1)),'*g','MarkerSize',2.5);
end

if find(pvalues.EvI.L<0.01,1)
    plot(ax(2),xx(pvalues.EvI.L<0.01),ones(length(find(pvalues.EvI.L<0.01)),1)*(Ey*yl(2,2)-(Ey-1)*yl(2,1)),'*g','MarkerSize',2.5);
end

if find(pvalues.EvI.H<0.01,1)
    plot(ax(3),xx(pvalues.EvI.H<0.01),ones(length(find(pvalues.EvI.H<0.01)),1)*(Ey*yl(3,2)-(Ey-1)*yl(3,1)),'*g','MarkerSize',2.5);
end


if find(pvalues.EvI.HmL<0.01,1)
    plot(ax(4),xx(pvalues.EvI.HmL<0.01),ones(length(find(pvalues.EvI.HmL<0.01)),1)*(Ey*yl(4,2)-(Ey-1)*yl(4,1)),'*g','MarkerSize',2.5);
end

if find(pvalues.EvI.WAKE<0.01,1)
    plot(ax(5),xx(pvalues.EvI.WAKE<0.01),ones(length(find(pvalues.EvI.WAKE<0.01)),1)*(Ey*yl(5,2)-(Ey-1)*yl(5,1)),'*g','MarkerSize',2.5);
end

if find(pvalues.EvI.WAKEL<0.01,1)
    plot(ax(6),xx(pvalues.EvI.WAKEL<0.01),ones(length(find(pvalues.EvI.WAKEL<0.01)),1)*(Ey*yl(6,2)-(Ey-1)*yl(6,1)),'*g','MarkerSize',2.5);
end

if find(pvalues.EvI.WAKEH<0.01,1)
    plot(ax(7),xx(pvalues.EvI.WAKEH<0.01),ones(length(find(pvalues.EvI.WAKEH<0.01)),1)*(Ey*yl(7,2)-(Ey-1)*yl(7,1)),'*g','MarkerSize',2.5);
end

if find(pvalues.EvI.WAKEHmL<0.01,1)
    plot(ax(8),xx(pvalues.EvI.WAKEHmL<0.01),ones(length(find(pvalues.EvI.WAKEHmL<0.01)),1)*(Ey*yl(8,2)-(Ey-1)*yl(8,1)),'*g','MarkerSize',2.5);
end

if find(pvalues.EvI.NREM<0.01,1)
    plot(ax(9),xx(pvalues.EvI.NREM<0.01),ones(length(find(pvalues.EvI.NREM<0.01)),1)*(Ey*yl(9,2)-(Ey-1)*yl(9,1)),'*g','MarkerSize',2.5);
end

if find(pvalues.EvI.NREML<0.01,1)
    plot(ax(10),xx(pvalues.EvI.NREML<0.01),ones(length(find(pvalues.EvI.NREML<0.01)),1)*(Ey*yl(10,2)-(Ey-1)*yl(10,1)),'*g','MarkerSize',2.5);
end

if find(pvalues.EvI.NREMH<0.01,1)
    plot(ax(11),xx(pvalues.EvI.NREMH<0.01),ones(length(find(pvalues.EvI.NREMH<0.01)),1)*(Ey*yl(11,2)-(Ey-1)*yl(11,1)),'*g','MarkerSize',2.5);
end

if find(pvalues.EvI.NREMHmL<0.01,1)
    plot(ax(12),xx(pvalues.EvI.NREMHmL<0.01),ones(length(find(pvalues.EvI.NREMHmL<0.01)),1)*(Ey*yl(12,2)-(Ey-1)*yl(12,1)),'*g','MarkerSize',2.5);
end

if ~isempty(PhstPS.REMphst)
    if find(pvalues.EvI.REM<0.01,1)
        plot(ax(13),xx(pvalues.EvI.REM<0.01),ones(length(find(pvalues.EvI.REM<0.01)),1)*(Ey*yl(13,2)-(Ey-1)*yl(13,1)),'*g','MarkerSize',2.5);
    end
 
    if find(pvalues.EvI.REML<0.01,1)
        plot(ax(14),xx(pvalues.EvI.REML<0.01),ones(length(find(pvalues.EvI.REML<0.01)),1)*(Ey*yl(14,2)-(Ey-1)*yl(14,1)),'*g','MarkerSize',2.5);
    end

    if find(pvalues.EvI.REMH<0.01,1)
        plot(ax(15),xx(pvalues.EvI.REMH<0.01),ones(length(find(pvalues.EvI.REMH<0.01)),1)*(Ey*yl(15,2)-(Ey-1)*yl(15,1)),'*g','MarkerSize',2.5);
    end

    if find(pvalues.EvI.REMHmL<0.01,1)
        plot(ax(16),xx(pvalues.EvI.REMHmL<0.01),ones(length(find(pvalues.EvI.REMHmL<0.01)),1)*(Ey*yl(16,2)-(Ey-1)*yl(16,1)),'*g','MarkerSize',2.5);
    end
end

if ~isempty(PhstPS.MAphst)
    if find(pvalues.EvI.MA<0.01,1)
        plot(ax(4*NumRow-3),xx(pvalues.EvI.MA<0.01),ones(length(find(pvalues.EvI.MA<0.01)),1)*(Ey*yl(4*NumRow-3,2)-(Ey-1)*yl(4*NumRow-3,1)),'*g','MarkerSize',2.5);
    end
 
    if find(pvalues.EvI.MAL<0.01,1)
        plot(ax(4*NumRow-2),xx(pvalues.EvI.MAL<0.01),ones(length(find(pvalues.EvI.MAL<0.01)),1)*(Ey*yl(4*NumRow-2,2)-(Ey-1)*yl(4*NumRow-2,1)),'*g','MarkerSize',2.5);
    end

    if find(pvalues.EvI.MAH<0.01,1)
        plot(ax(4*NumRow-1),xx(pvalues.EvI.MAH<0.01),ones(length(find(pvalues.EvI.MAH<0.01)),1)*(Ey*yl(4*NumRow-1,2)-(Ey-1)*yl(4*NumRow-1,1)),'*g','MarkerSize',2.5);
    end

    if find(pvalues.EvI.MAHmL<0.01,1)
        plot(ax(4*NumRow),xx(pvalues.EvI.MAHmL<0.01),ones(length(find(pvalues.EvI.MAHmL<0.01)),1)*(Ey*yl(4*NumRow,2)-(Ey-1)*yl(4*NumRow,1)),'*g','MarkerSize',2.5);
    end
