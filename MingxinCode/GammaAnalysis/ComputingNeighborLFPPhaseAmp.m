function [neighborPhases,neighborAmp,cellneighborIdx] = ComputingNeighborLFPPhaseAmp(phases,amp,shank,LFPShanks,neighborShanks)
...
for i = 1:length(GoodUnitShanks)
    ...
    if length(neighbor)==1
        ...
        neighborAmp{i} = amp{LFPShanks==neighbor};
