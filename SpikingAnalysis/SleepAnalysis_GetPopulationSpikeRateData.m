function [binnedTrains] = SleepAnalysis_GetPopulationSpikeRateData(S,Se,Si,CellIDs)
...
binnedEachCell = MakeQfromS(S,binningfactor);%bin every 100000pts, which is 10sec (10000 pts per sec)
