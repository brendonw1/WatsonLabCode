function SWSREMSWSEpisode_Transfers = SpikingAnalysis_GetTripletEpisodeSpikeTransfers(basename,basepath,intervals,PrePostSleepMetaData,S,funcsynapses,percell,normalize)
