...
h = subplot(2,1,1);
plot([KetamineTimeStamp/10 KetamineTimeStamp/10],get(gca,'XLim'));
h = subplot(2,1,2);
plot([KetamineTimeStamp/10 KetamineTimeStamp/10],get(gca,'XLim'));
...
if exist('states','var')
    SpikingAnalysis_PlotAveragedSpikeRatesBeforeAndAfterInjection_S(basepath,basename,KetamineTimeStamp,S,Se,Si,RecordingStartsAndEnds,states);
else
    SpikingAnalysis_PlotAveragedSpikeRatesBeforeAndAfterInjection_S(basepath,basename,KetamineTimeStamp,S,Se,Si,RecordingStartsAndEnds)
end
