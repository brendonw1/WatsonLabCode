function Spindles_BasicOverlaysForStateEditor(basename,iss,SpindleData)
...
save(fullfile('Spindles',[basename '_StateEditorOverlay_SpindleSpkcountDurationSpkrate' celltype]),'CountDurRate')
