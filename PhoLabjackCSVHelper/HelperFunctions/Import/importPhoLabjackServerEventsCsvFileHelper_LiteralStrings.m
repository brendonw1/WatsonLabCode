function output = importPhoLabjackServerEventsCsvFileHelper_LiteralStrings(filename, dataLines)
...
%opts.VariableNames = ["milliseconds_since_epoch", "DIO0", "DIO1", "DIO2", "DIO3", "DIO4", "DIO5", "DIO6", "DIO7", "AIN0"];
opts.VariableNames = ["computerTime", "EIO0", "EIO1", "EIO2", "EIO3", "EIO4", "EIO5", "EIO6", "EIO7", "AIN0"];
opts.VariableTypes = ["string", "string", "string", "string", "string", "string", "string", "string", "string", "string"];
% opts.VariableNames = ["milliseconds_since_epoch", "DIO0", "DIO1", "DIO2", "DIO3", "DIO4", "DIO5", "DIO6", "DIO7"];
