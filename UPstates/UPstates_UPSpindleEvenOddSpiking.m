function h = UPstates_UPSpindleEvenOddSpiking(basepath,basename)
...
% All UPs
[r_ue_rate,p_ue_rate,h(end+1)] = PlotEvenOddVectorSimilarity(uisse.spkrates,uSleepStartIdxs,uSleepStopIdxs);
AboveTitle('AllUPs: ECellRates')
set(h(end),'name',[basename '_SleepHalfCorr_AllUPsECellRates'])
% Spindle UPs
[r_sue_rate,p_sue_rate,h(end+1)] = PlotEvenOddVectorSimilarity(Suisse.spkrates,uSleepStartIdxs,uSleepStopIdxs,Suisse.intervalsubset);
AboveTitle('SpindleUPs: ECellRates')
set(h(end),'name',[basename '_SleepHalfCorr_SpindleUPsECellRates'])
% Non Spindle UPs
[r_nue_rate,p_nue_rate,h(end+1)] = PlotEvenOddVectorSimilarity(Nuisse.spkrates,uSleepStartIdxs,uSleepStopIdxs,Nuisse.intervalsubset);
AboveTitle('NonSpindleUPs: ECellRates')
set(h(end),'name',[basename '_SleepHalfCorr_NonSpindleUPsECellRates'])
% Partial Spindle UPs
[r_pue_rate,p_pue_rate,h(end+1)] = PlotEvenOddVectorSimilarity(Puisse.spkrates,uSleepStartIdxs,uSleepStopIdxs,Puisse.intervalsubset);
AboveTitle('PartialSpindleUPs: ECellRates')
set(h(end),'name',[basename '_SleepHalfCorr_PartSpindleUPsECellRates'])
% Early Spindle UPs
[r_eue_rate,p_eue_rate,h(end+1)] = PlotEvenOddVectorSimilarity(Euisse.spkrates,uSleepStartIdxs,uSleepStopIdxs,Euisse.intervalsubset);
AboveTitle('EarlySpindleUPs: ECellRates')
set(h(end),'name',[basename '_SleepHalfCorr_EarlySpindleUPsECellRates'])
% Late Spindle UPs
[r_lue_rate,p_lue_rate,h(end+1)] = PlotEvenOddVectorSimilarity(Luisse.spkrates,uSleepStartIdxs,uSleepStopIdxs,Luisse.intervalsubset);
AboveTitle('LateSpindleUPs: ECellRates')
set(h(end),'name',[basename '_SleepHalfCorr_LateSpindleUPsECellRates'])
% Spindles
[r_se_rate,p_se_rate,h(end+1)] = PlotEvenOddVectorSimilarity(sisse.meanspktsfrompeak,sSleepStartIdxs,sSleepStopIdxs);
...
[r_ue_seq_meanvpeak,p_ue_seq_meanvpeak,h(end+1)] = PlotEvenOddVectorSimilarity(uisse.meanspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs);
AboveTitle('AllUPs: ECellMean vs EventPeak')
set(h(end),'name',[basename '_SleepHalfCorr_AllUPsECellMeanVEventPeak'])
[r_ue_seq_meanvstart,p_ue_seq_meanvstart,h(end+1)] = PlotEvenOddVectorSimilarity(uisse.meanspktsfromstart,uSleepStartIdxs,uSleepStopIdxs);
AboveTitle('AllUPs: ECellMean vs EventStart')
set(h(end),'name',[basename '_SleepHalfCorr_AllUPsECellMeanVEventStart'])
[r_ue_seq_firstvpeak,p_ue_seq_firstvpeak,h(end+1)] = PlotEvenOddVectorSimilarity(uisse.firstspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs);
AboveTitle('AllUPs: ECellFirst vs EventPeak')
set(h(end),'name',[basename '_SleepHalfCorr_AllUPsECellFirstVEventPeak'])
[r_ue_seq_firstvstart,p_ue_seq_firstvstart,h(end+1)] = PlotEvenOddVectorSimilarity(uisse.firstspktsfromstart,uSleepStartIdxs,uSleepStopIdxs);
...
% SpindleUPs
[r_sue_seq_meanvpeak,p_sue_seq_meanvpeak,h(end+1)] = PlotEvenOddVectorSimilarity(Suisse.meanspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Suisse.intervalsubset);
AboveTitle('SpindleUPs: ECellMean vs EventPeak')
set(h(end),'name',[basename '_SleepHalfCorr_SpindleUPsECellMeanVEventPeak'])
[r_sue_seq_meanvstart,p_sue_seq_meanvstart,h(end+1)] = PlotEvenOddVectorSimilarity(Suisse.meanspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Suisse.intervalsubset);
AboveTitle('SpindleUPs: ECellMean vs EventStart')
set(h(end),'name',[basename '_SleepHalfCorr_SpindleUPsECellMeanVEventStart'])
[r_sue_seq_firstvpeak,p_sue_seq_firstvpeak,h(end+1)] = PlotEvenOddVectorSimilarity(Suisse.firstspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Suisse.intervalsubset);
AboveTitle('SpindleUPs: ECellFirst vs EventPeak')
set(h(end),'name',[basename '_SleepHalfCorr_SpindleUPsECellFirstVEventPeak'])
[r_sue_seq_firstvstart,p_sue_seq_firstvstart,h(end+1)] = PlotEvenOddVectorSimilarity(Suisse.firstspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Suisse.intervalsubset);
AboveTitle('SpindleUPs: ECellFirst vs EventStart')
set(h(end),'name',[basename '_SleepHalfCorr_SpindleUPsECellFirstVEventStart'])

% NonSpindleUps
[r_nue_seq_meanvpeak,p_nue_seq_meanvpeak,h(end+1)] = PlotEvenOddVectorSimilarity(Nuisse.meanspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Nuisse.intervalsubset);
AboveTitle('NonSpindleUPs: ECellMean vs EventPeak')
set(h(end),'name',[basename '_SleepHalfCorr_NonSpindleUPsECellMeanVEventPeak'])
[r_nue_seq_meanvstart,p_nue_seq_meanvstart,h(end+1)] = PlotEvenOddVectorSimilarity(Nuisse.meanspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Nuisse.intervalsubset);
AboveTitle('NonSpindleUPs: ECellMean vs EventStart')
set(h(end),'name',[basename '_SleepHalfCorr_NonSpindleUPsECellMeanVEventStart'])
[r_nue_seq_firstvpeak,p_nue_seq_firstvpeak,h(end+1)] = PlotEvenOddVectorSimilarity(Nuisse.firstspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Nuisse.intervalsubset);
AboveTitle('NonSpindleUPs: ECellFirst vs EventPeak')
set(h(end),'name',[basename '_SleepHalfCorr_NonSpindleUPsECellFirstVEventPeak'])
[r_nue_seq_firstvstart,p_nue_seq_firstvstart,h(end+1)] = PlotEvenOddVectorSimilarity(Nuisse.firstspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Nuisse.intervalsubset);
...
% Partial Spindle UPs
[r_pue_seq_meanvpeak,p_pue_seq_meanvpeak,h(end+1)] = PlotEvenOddVectorSimilarity(Puisse.meanspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Puisse.intervalsubset);
...
[r_pue_seq_meanvstart,p_pue_seq_meanvstart,h(end+1)] = PlotEvenOddVectorSimilarity(Puisse.meanspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Puisse.intervalsubset);
...
[r_pue_seq_firstvpeak,p_pue_seq_firstvpeak,h(end+1)] = PlotEvenOddVectorSimilarity(Puisse.firstspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Puisse.intervalsubset);
...
[r_pue_seq_firstvstart,p_pue_seq_firstvstart,h(end+1)] = PlotEvenOddVectorSimilarity(Puisse.firstspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Puisse.intervalsubset);
...
% Early Spindle UPs
[r_eue_seq_meanvpeak,p_eue_seq_meanvpeak,h(end+1)] = PlotEvenOddVectorSimilarity(Euisse.meanspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Euisse.intervalsubset);
...
[r_eue_seq_meanvstart,p_eue_seq_meanvstart,h(end+1)] = PlotEvenOddVectorSimilarity(Euisse.meanspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Euisse.intervalsubset);
...
[r_eue_seq_firstvpeak,p_eue_seq_firstvpeak,h(end+1)] = PlotEvenOddVectorSimilarity(Euisse.firstspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Euisse.intervalsubset);
...
[r_eue_seq_firstvstart,p_eue_seq_firstvstart,h(end+1)] = PlotEvenOddVectorSimilarity(Euisse.firstspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Euisse.intervalsubset);
...
% Late Spindle UPs
[r_lue_seq_meanvpeak,p_lue_seq_meanvpeak,h(end+1)] = PlotEvenOddVectorSimilarity(Luisse.meanspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Luisse.intervalsubset);
AboveTitle('LateSpindleUPs: ECellMean vs EventPeak')
set(h(end),'name',[basename '_SleepHalfCorr_LateSpindleUPsECellMeanVEventPeak'])
[r_lue_seq_meanvstart,p_lue_seq_meanvstart,h(end+1)] = PlotEvenOddVectorSimilarity(Luisse.meanspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Luisse.intervalsubset);
...
[r_lue_seq_firstvpeak,p_lue_seq_firstvpeak,h(end+1)] = PlotEvenOddVectorSimilarity(Luisse.firstspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Luisse.intervalsubset);
...
[r_lue_seq_firstvstart,p_lue_seq_firstvstart,h(end+1)] = PlotEvenOddVectorSimilarity(Luisse.firstspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Luisse.intervalsubset);
...
% Spindles
[r_se_seq_meanvpeak,p_se_seq_meanvpeak,h(end+1)] = PlotEvenOddVectorSimilarity(sisse.meanspktsfrompeak,sSleepStartIdxs,sSleepStopIdxs);
AboveTitle('AllSpindles: ECellMean vs EventPeak')
[r_se_seq_meanvstart,p_se_seq_meanvstart,h(end+1)] = PlotEvenOddVectorSimilarity(sisse.meanspktsfromstart,sSleepStartIdxs,sSleepStopIdxs);
AboveTitle('AllSpidles: ECellMean vs EventStart')
[r_se_seq_firstvpeak,p_se_seq_firstvpeak,h(end+1)] = PlotEvenOddVectorSimilarity(sisse.firstspktsfrompeak,sSleepStartIdxs,sSleepStopIdxs);
AboveTitle('AllSpindles: ECellFirst vs EventPeak')
[r_se_seq_firstvstart,p_se_seq_firstvstart,h(end+1)] = PlotEvenOddVectorSimilarity(sisse.firstspktsfromstart,sSleepStartIdxs,sSleepStopIdxs);
...
save(fullfile('UPstates',[basename '_SpindleUPEvenOddRsAndPs.mat']),'SpindleUPEvenOddRsAndPs')
...
if ~exist('SpindleUPEvenOddFigs','dir')
    mkdir('SpindleUPEvenOddFigs')
end
cd('SpindleUPEvenOddFigs')
...
function [r,p,h] = PlotEvenOddVectorSimilarity(celleventvectors,SleepStartIdxs,SleepStopIdxs,subset,h,subplotixs)
...
%     axis equal
    hold on;
    title(['Sleep ' num2str(a) '. n = ' num2str(size(subset,2)) ' events.'])
