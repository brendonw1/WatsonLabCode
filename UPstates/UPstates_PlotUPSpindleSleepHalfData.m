function UPstates_PlotUPSpindleSleepHalfData(UPSpindleHalfData)

if ~exist('UPSpindleHalfData','var')
    UPSpindleHalfData = UPstates_GatherUPSpindleSleepHalfData;
end
v2struct(UPSpindleHalfData)%extracts field names as variables (necessary for labeling in fcns below)
...
%% Save figs 
od = cd;
savedir = '/mnt/brendon4/Dropbox/Data/SpindleUPDatasetData/SleepHalf';
