function h = UPstates_UPSpindleSleepHalfSpiking_Restrict(basepath,basename)
...
numevts = GetHalvesNumEvts(Suisse.meanspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Suisse.intervalsubset);

h = [];
%% First vs second half spike rate similarity
% All UPs
[r_ue_rate,p_ue_rate,h(end+1)] = PlotHalvesVectorSimilarity(uisse.spkrates,uSleepStartIdxs,uSleepStopIdxs,1:size(uisse.spkrates,1),numevts);
AboveTitle('AllUPs: ECellRates')
set(h(end),'name',[basename '_SleepHalfCorr_AllUPsECellRates'])
% Spindle UPs
[r_sue_rate,p_sue_rate,h(end+1)] = PlotHalvesVectorSimilarity(Suisse.spkrates,uSleepStartIdxs,uSleepStopIdxs,Suisse.intervalsubset,numevts);
AboveTitle('SpindleUPs: ECellRates')
set(h(end),'name',[basename '_SleepHalfCorr_SpindleUPsECellRates'])
% Non Spindle UPs
[r_nue_rate,p_nue_rate,h(end+1)] = PlotHalvesVectorSimilarity(Nuisse.spkrates,uSleepStartIdxs,uSleepStopIdxs,Nuisse.intervalsubset,numevts);
AboveTitle('NonSpindleUPs: ECellRates')
set(h(end),'name',[basename '_SleepHalfCorr_NonSpindleUPsECellRates'])
% Partial Spindle UPs
[r_pue_rate,p_pue_rate,h(end+1)] = PlotHalvesVectorSimilarity(Puisse.spkrates,uSleepStartIdxs,uSleepStopIdxs,Puisse.intervalsubset,numevts);
AboveTitle('PartialSpindleUPs: ECellRates')
set(h(end),'name',[basename '_SleepHalfCorr_PartSpindleUPsECellRates'])
% Early Spindle UPs
[r_eue_rate,p_eue_rate,h(end+1)] = PlotHalvesVectorSimilarity(Euisse.spkrates,uSleepStartIdxs,uSleepStopIdxs,Euisse.intervalsubset,numevts);
AboveTitle('EarlySpindleUPs: ECellRates')
set(h(end),'name',[basename '_SleepHalfCorr_EarlySpindleUPsECellRates'])
% Late Spindle UPs
[r_lue_rate,p_lue_rate,h(end+1)] = PlotHalvesVectorSimilarity(Luisse.spkrates,uSleepStartIdxs,uSleepStopIdxs,Luisse.intervalsubset,numevts);
AboveTitle('LateSpindleUPs: ECellRates')
set(h(end),'name',[basename '_SleepHalfCorr_LateSpindleUPsECellRates'])
% Spindles
[r_se_rate,p_se_rate,h(end+1)] = PlotHalvesVectorSimilarity(sisse.meanspktsfrompeak,sSleepStartIdxs,sSleepStopIdxs,1:size(sisse.spkrates,1),numevts);
...
[r_ue_seq_meanvpeak,p_ue_seq_meanvpeak,h(end+1)] = PlotHalvesVectorSimilarity(uisse.meanspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,1:size(uisse.spkrates,1),numevts);
AboveTitle('AllUPs: ECellMean vs EventPeak')
set(h(end),'name',[basename '_SleepHalfCorr_AllUPsECellMeanVEventPeak'])
[r_ue_seq_meanvstart,p_ue_seq_meanvstart,h(end+1)] = PlotHalvesVectorSimilarity(uisse.meanspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,1:size(uisse.spkrates,1),numevts);
AboveTitle('AllUPs: ECellMean vs EventStart')
set(h(end),'name',[basename '_SleepHalfCorr_AllUPsECellMeanVEventStart'])
[r_ue_seq_firstvpeak,p_ue_seq_firstvpeak,h(end+1)] = PlotHalvesVectorSimilarity(uisse.firstspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,1:size(uisse.spkrates,1),numevts);
AboveTitle('AllUPs: ECellFirst vs EventPeak')
set(h(end),'name',[basename '_SleepHalfCorr_AllUPsECellFirstVEventPeak'])
[r_ue_seq_firstvstart,p_ue_seq_firstvstart,h(end+1)] = PlotHalvesVectorSimilarity(uisse.firstspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,1:size(uisse.spkrates,1),numevts);
...
% SpindleUPs
[r_sue_seq_meanvpeak,p_sue_seq_meanvpeak,h(end+1)] = PlotHalvesVectorSimilarity(Suisse.meanspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Suisse.intervalsubset,numevts);
AboveTitle('SpindleUPs: ECellMean vs EventPeak')
set(h(end),'name',[basename '_SleepHalfCorr_SpindleUPsECellMeanVEventPeak'])
[r_sue_seq_meanvstart,p_sue_seq_meanvstart,h(end+1)] = PlotHalvesVectorSimilarity(Suisse.meanspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Suisse.intervalsubset,numevts);
AboveTitle('SpindleUPs: ECellMean vs EventStart')
set(h(end),'name',[basename '_SleepHalfCorr_SpindleUPsECellMeanVEventStart'])
[r_sue_seq_firstvpeak,p_sue_seq_firstvpeak,h(end+1)] = PlotHalvesVectorSimilarity(Suisse.firstspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Suisse.intervalsubset,numevts);
AboveTitle('SpindleUPs: ECellFirst vs EventPeak')
set(h(end),'name',[basename '_SleepHalfCorr_SpindleUPsECellFirstVEventPeak'])
[r_sue_seq_firstvstart,p_sue_seq_firstvstart,h(end+1)] = PlotHalvesVectorSimilarity(Suisse.firstspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Suisse.intervalsubset,numevts);
AboveTitle('SpindleUPs: ECellFirst vs EventStart')
set(h(end),'name',[basename '_SleepHalfCorr_SpindleUPsECellFirstVEventStart'])

% NonSpindleUps
[r_nue_seq_meanvpeak,p_nue_seq_meanvpeak,h(end+1)] = PlotHalvesVectorSimilarity(Nuisse.meanspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Nuisse.intervalsubset,numevts);
AboveTitle('NonSpindleUPs: ECellMean vs EventPeak')
set(h(end),'name',[basename '_SleepHalfCorr_NonSpindleUPsECellMeanVEventPeak'])
[r_nue_seq_meanvstart,p_nue_seq_meanvstart,h(end+1)] = PlotHalvesVectorSimilarity(Nuisse.meanspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Nuisse.intervalsubset,numevts);
AboveTitle('NonSpindleUPs: ECellMean vs EventStart')
set(h(end),'name',[basename '_SleepHalfCorr_NonSpindleUPsECellMeanVEventStart'])
[r_nue_seq_firstvpeak,p_nue_seq_firstvpeak,h(end+1)] = PlotHalvesVectorSimilarity(Nuisse.firstspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Nuisse.intervalsubset,numevts);
AboveTitle('NonSpindleUPs: ECellFirst vs EventPeak')
set(h(end),'name',[basename '_SleepHalfCorr_NonSpindleUPsECellFirstVEventPeak'])
[r_nue_seq_firstvstart,p_nue_seq_firstvstart,h(end+1)] = PlotHalvesVectorSimilarity(Nuisse.firstspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Nuisse.intervalsubset,numevts);
...
% Partial Spindle UPs
[r_pue_seq_meanvpeak,p_pue_seq_meanvpeak,h(end+1)] = PlotHalvesVectorSimilarity(Puisse.meanspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Puisse.intervalsubset,numevts);
...
[r_pue_seq_meanvstart,p_pue_seq_meanvstart,h(end+1)] = PlotHalvesVectorSimilarity(Puisse.meanspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Puisse.intervalsubset,numevts);
...
[r_pue_seq_firstvpeak,p_pue_seq_firstvpeak,h(end+1)] = PlotHalvesVectorSimilarity(Puisse.firstspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Puisse.intervalsubset,numevts);
...
[r_pue_seq_firstvstart,p_pue_seq_firstvstart,h(end+1)] = PlotHalvesVectorSimilarity(Puisse.firstspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Puisse.intervalsubset,numevts);
...
% Early Spindle UPs
[r_eue_seq_meanvpeak,p_eue_seq_meanvpeak,h(end+1)] = PlotHalvesVectorSimilarity(Euisse.meanspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Euisse.intervalsubset,numevts);
...
[r_eue_seq_meanvstart,p_eue_seq_meanvstart,h(end+1)] = PlotHalvesVectorSimilarity(Euisse.meanspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Euisse.intervalsubset,numevts);
...
[r_eue_seq_firstvpeak,p_eue_seq_firstvpeak,h(end+1)] = PlotHalvesVectorSimilarity(Euisse.firstspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Euisse.intervalsubset,numevts);
...
[r_eue_seq_firstvstart,p_eue_seq_firstvstart,h(end+1)] = PlotHalvesVectorSimilarity(Euisse.firstspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Euisse.intervalsubset,numevts);
...
% Late Spindle UPs
[r_lue_seq_meanvpeak,p_lue_seq_meanvpeak,h(end+1)] = PlotHalvesVectorSimilarity(Luisse.meanspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Luisse.intervalsubset,numevts);
AboveTitle('LateSpindleUPs: ECellMean vs EventPeak')
set(h(end),'name',[basename '_SleepHalfCorr_LateSpindleUPsECellMeanVEventPeak'])
[r_lue_seq_meanvstart,p_lue_seq_meanvstart,h(end+1)] = PlotHalvesVectorSimilarity(Luisse.meanspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Luisse.intervalsubset,numevts);
...
[r_lue_seq_firstvpeak,p_lue_seq_firstvpeak,h(end+1)] = PlotHalvesVectorSimilarity(Luisse.firstspktsfrompeak,uSleepStartIdxs,uSleepStopIdxs,Luisse.intervalsubset,numevts);
...
[r_lue_seq_firstvstart,p_lue_seq_firstvstart,h(end+1)] = PlotHalvesVectorSimilarity(Luisse.firstspktsfromstart,uSleepStartIdxs,uSleepStopIdxs,Luisse.intervalsubset,numevts);
...
% Spindles
[r_se_seq_meanvpeak,p_se_seq_meanvpeak,h(end+1)] = PlotHalvesVectorSimilarity(sisse.meanspktsfrompeak,sSleepStartIdxs,sSleepStopIdxs,1:size(sisse.spkrates,1),numevts);
AboveTitle('AllSpindles: ECellMean vs EventPeak')
[r_se_seq_meanvstart,p_se_seq_meanvstart,h(end+1)] = PlotHalvesVectorSimilarity(sisse.meanspktsfromstart,sSleepStartIdxs,sSleepStopIdxs,1:size(sisse.spkrates,1),numevts);
AboveTitle('AllSpidles: ECellMean vs EventStart')
[r_se_seq_firstvpeak,p_se_seq_firstvpeak,h(end+1)] = PlotHalvesVectorSimilarity(sisse.firstspktsfrompeak,sSleepStartIdxs,sSleepStopIdxs,1:size(sisse.spkrates,1),numevts);
AboveTitle('AllSpindles: ECellFirst vs EventPeak')
[r_se_seq_firstvstart,p_se_seq_firstvstart,h(end+1)] = PlotHalvesVectorSimilarity(sisse.firstspktsfromstart,sSleepStartIdxs,sSleepStopIdxs,1:size(sisse.spkrates,1),numevts);
...
%Rs for rates
h(end+1) = figure;
hax = plot_nanmeanSD_bars(r_ue_rate,r_nue_rate,r_sue_rate,r_pue_rate,r_eue_rate,r_lue_rate,r_se_rate);
...
h(end+1) = figure;
subplot(2,1,1)
hax = plot_nanmeanSD_bars(r_ue_seq_meanvstart,r_nue_seq_meanvstart, r_sue_seq_meanvstart,r_pue_seq_meanvstart,r_eue_seq_meanvstart,r_lue_seq_meanvstart,r_se_seq_meanvstart);
title(hax,'Spike Timing: MeanVsStart')
subplot(2,1,2)
hax = plot_nanmeanSD_bars(r_ue_seq_firstvpeak,r_nue_seq_firstvpeak, r_sue_seq_firstvpeak,r_pue_seq_firstvpeak,r_eue_seq_firstvpeak,r_lue_seq_firstvpeak,r_se_seq_firstvpeak);
...
function [r,p,h] = PlotHalvesVectorSimilarity(celleventvectors,SleepStartIdxs,SleepStopIdxs,subset,numevts)
% 
% if ~exist('subset','var')
...
%     half2stop = subset(find(subset<=half2stop,1,'last'));
    ...
    randixs1 = randperm(size(timeshalf1,1));
    randixs1 = randixs1(1:min([numevts(a,1) size(timeshalf1,1)]));
    randixs2 = randperm(size(timeshalf2,1));
    randixs2 = randixs2(1:min([numevts(a,2) size(timeshalf2,1)]));
    x = nanmean(timeshalf1(randixs1,:),1);
    y = nanmean(timeshalf2(randixs2,:),1);

    subplot(length(SleepStartIdxs),1,a)
    plot(x,y,'.');
%     axis equal
    hold on;
    title(['Sleep ' num2str(a) '. n = ' num2str(numevts(a,1)) ',' num2str(numevts(a,2)) ' events.'])
    ...
    try
        ...
        text(.05*(xl(2)-xl(1))+xl(1),.9*(yl(2)-yl(1))+yl(1),['r = ' num2str(r(end)) '. p = ' num2str(p(end)) '.'])
    catch 
        r(end+1) = nan;
        p(end+1) = nan;
    end
