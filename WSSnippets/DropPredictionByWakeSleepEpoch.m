...
PerCellSlope = Slopes.MedianOfNormE;
...
% pppE = ConditionedProportion(ESpikeRateEarly,ESpikeRateLate);
...
subplot(2,6,1:2)
[p,r,slope,SlopeCI, intercept, yfit] = ScatterWStats(wakebe,PerCellSlope,'logx','max','none');
title('Wake Before')
subplot(2,6,3:4)
[p,r,slope,SlopeCI, intercept, yfit] = ScatterWStats(wssleepe,PerCellSlope,'logx','max','none');
title('Sleep')
subplot(2,6,5:6)
[p,r,slope,SlopeCI, intercept, yfit] = ScatterWStats(wakeae,PerCellSlope,'logx','max','none');
title('Wake After')
subplot(2,6,8:9)
[p,r,slope,SlopeCI, intercept, yfit] = ScatterWStats(wsswse,PerCellSlope,'logx','max','none');
title('SWS')
subplot(2,6,10:11)
[p,r,slope,SlopeCI, intercept, yfit] = ScatterWStats(wsreme,PerCellSlope,'logx','max','none');
title('REM')


figure('position',[2 0 1200 900]);%plot Wake,Sleep,Wake and SWS,REM under
subplot(4,4,1)
    [p_wakeb1qe,r,slope_wakeb1qe,SlopeCI, intercept, yfit] = ScatterWStats(wakeb1qe,PerCellSlope,'logx','max','none');
    title('Wake Before Q1')
subplot(4,4,2)
    [p_wakeb2qe,r,slope_wakeb2qe,SlopeCI, intercept, yfit] = ScatterWStats(wakeb2qe,PerCellSlope,'logx','max','none');
    title('Wake Before Q2')
subplot(4,4,3)
    [p_wakeb3qe,r,slope_wakeb3qe,SlopeCI, intercept, yfit] = ScatterWStats(wakeb3qe,PerCellSlope,'logx','max','none');
    title('Wake Before Q3')
subplot(4,4,4)
    [p_wakeb4qe,r,slope_wakeb4qe,SlopeCI, intercept, yfit] = ScatterWStats(wakeb4qe,PerCellSlope,'logx','max','none');
    title('Wake Before Q4')

subplot(4,4,5)
    [p_wssws1qe,r,slope_wssws1qe,SlopeCI, intercept, yfit] = ScatterWStats(wssws1qe,PerCellSlope,'logx','max','none');
    title('SWS Q1')
subplot(4,4,6)
    [p_wssws2qe,r,slope_wssws2qe,SlopeCI, intercept, yfit] = ScatterWStats(wssws2qe,PerCellSlope,'logx','max','none');
    title('SWS Q2')
subplot(4,4,7)
    [p_wssws3qe,r,slope_wssws3qe,SlopeCI, intercept, yfit] = ScatterWStats(wssws3qe,PerCellSlope,'logx','max','none');
    title('SWS Q3')
subplot(4,4,8)
    [p_wssws4qe,r,slope_wssws4qe,SlopeCI, intercept, yfit] = ScatterWStats(wssws4qe,PerCellSlope,'logx','max','none');
    title('SWS Q4')

subplot(4,4,9)
    [p_wsrem1qe,r,slope_wsrem1qe,SlopeCI, intercept, yfit] = ScatterWStats(wsrem1qe,PerCellSlope,'logx','max','none');
    title('REM Q1')
subplot(4,4,10)
    [p_wsrem2qe,r,slope_wsrem2qe,SlopeCI, intercept, yfit] = ScatterWStats(wsrem2qe,PerCellSlope,'logx','max','none');
    title('REM Q2')
subplot(4,4,11)
    [p_wsrem3qe,r,slope_wsrem3qe,SlopeCI, intercept, yfit] = ScatterWStats(wsrem3qe,PerCellSlope,'logx','max','none');
    title('REM Q3')
subplot(4,4,12)
    [p_wsrem4qe,r,slope_wsrem4qe,SlopeCI, intercept, yfit] = ScatterWStats(wsrem4qe,PerCellSlope,'logx','max','none');
    title('REM Q4')

subplot(4,4,13)
    [p_wakea1qe,r,slope_wakea1qe,SlopeCI, intercept, yfit] = ScatterWStats(wakea1qe,PerCellSlope,'logx','max','none');
    title('Wake After Q1')
subplot(4,4,14)
    [p_wakea2qe,r,slope_wakea2qe,SlopeCI, intercept, yfit] = ScatterWStats(wakea2qe,PerCellSlope,'logx','max','none');
    title('Wake After Q2')
subplot(4,4,15)
    [p_wakea3qe,r,slope_wakea3qe,SlopeCI, intercept, yfit] = ScatterWStats(wakea3qe,PerCellSlope,'logx','max','none');
    title('Wake After Q3')
subplot(4,4,16)
    [p_wakea4qe,r,slope_wakea4qe,SlopeCI, intercept, yfit] = ScatterWStats(wakea4qe,PerCellSlope,'logx','max','none');
    title('Wake After Q4')
