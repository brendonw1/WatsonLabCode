...
for a = 1:length(dirs);
    ...
    times = HighLowFRRatioData.bincentertimes;
    data = HighLowFRRatioData.hrlr;
...
for b = 1:numstatetypes
    ...
    set(h(end),'name',['HighLowFRRatioOverSleepInts' statenames{b}])
end

MakeDirSaveVarThere('/mnt/brendon4/Dropbox/BW OUTPUT/SleepProject/PETHS/HighLowFRRatio/',EIRatioOverSleepInts)
MakeDirSaveFigsThereAs('/mnt/brendon4/Dropbox/BW OUTPUT/SleepProject/PETHS/HighLowFRRatio/',h)
MakeDirSaveFigsThereAs('/mnt/brendon4/Dropbox/BW OUTPUT/SleepProject/PETHS/HighLowFRRatio/',h,'png')
