function SleepPETHs_LowGammaIncidenceOverPacketsSWSEpsSleep
warning off
...
%% saving and plotting
LowGammaIncidenceOverSleepInts = v2struct(normbool,normmode,normperiod,sffororiginalepochs,binspernormepoch,statenames,...
...
%     set(h(end),'name',['UPDurationsOver' statenames{b}])
    ...
    set(h(end),'name',['LowGammaIncidenceOver' statenames{b}])
end

MakeDirSaveVarThere('/mnt/brendon4/Dropbox/BW OUTPUT/SleepProject/PETHS/UPs/',LowGammaIncidenceOverSleepInts)
