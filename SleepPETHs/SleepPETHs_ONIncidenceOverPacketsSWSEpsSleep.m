function SleepPETHs_ONIncidenceOverPacketsSWSEpsSleep
warning off
...
%% saving and plotting
ONIncidenceOverSleepInts = v2struct(normbool,normmode,normperiod,sffororiginalepochs,binspernormepoch,statenames,...
...
%     set(h(end),'name',['UPDurationsOver' statenames{b}])
    ...
    set(h(end),'name',['ONIncidenceOver' statenames{b}])
end

MakeDirSaveVarThere('/mnt/brendon4/Dropbox/BW OUTPUT/SleepProject/PETHS/UPs/',ONIncidenceOverSleepInts)
