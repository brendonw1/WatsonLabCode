function SleepPETHs_UPIncidenceOverPaccketsSWSEpsSleep
warning off
...
%% saving and plotting
UPIncidenceOverSleepInts = v2struct(normbool,normmode,normperiod,sffororiginalepochs,binspernormepoch,statenames,...
...
%     set(h(end),'name',['UPDurationsOver' statenames{b}])
    ...
    set(h(end),'name',['UPIncidenceOver' statenames{b}])
end

MakeDirSaveVarThere('/mnt/brendon4/Dropbox/BW OUTPUT/SleepProject/PETHS/UPs/',UPIncidenceOverSleepInts)
