function SleepPETHs_OFFIncidenceOverPacketsSWSEpsSleep
warning off
...
%% saving and plotting
OFFIncidenceOverSleepInts = v2struct(normbool,normmode,normperiod,sffororiginalepochs,binspernormepoch,statenames,...
...
%     set(h(end),'name',['UPDurationsOver' statenames{b}])
    ...
    set(h(end),'name',['OFFIncidenceOver' statenames{b}])
end

MakeDirSaveVarThere('/mnt/brendon4/Dropbox/BW OUTPUT/SleepProject/PETHS/UPs/',OFFIncidenceOverSleepInts)
